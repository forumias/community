...
<div class="main-wrapper d-flex flex-column justify-content-center">
    <div class="d-flex flex-row justify-content-center flex-wrap">
        <div class="profile-sidebar">
            @include('../Elements/users/left_side')
        </div>
		<?php $auth_user = @Auth::user(); ?>
        <div class="feed-area flex-grow-1 profile-feed">
            <div class="d-flex flex-row">
				...
				<?php /*<a href="#" class="profile-status-widget d-flex flex-row align-items-center"><span></span><span>Ask Mark a question</span></a> */?>
                    <div class="main_append" data-page="1"  data-acttype="4">
                        <?php /*<div class="post-card d-flex flex-row justify-content-between filter-bar">
