        ...
        <div class="feed-area">
            <div class="d-flex flex-row">
                <div class="feed-component">
                    <div class="feed-items-wrap">
                        <div class="post-card community-header-card">
                            <div class="d-flex flex-row flex-wrap">
                                <div class="community-details">
                                    <h1><a href="{{URL::to('/group/'.$tag_info->tag_slug)}}">{{$tag_info->title}}</a></h1>
                                    <p><?php echo nl2br($tag_info->description);?></p>
                                    <div class="d-flex flex-row align-items-center">
                                        <div class="d-flex flex-row align-items-center">
                                            <button class="follow-button group_follow <?php if($following > 0){ echo 'active';}?>" data-tid="{{$tag_info->id}}"><?php if($following > 0){ echo 'Following';}else{ echo 'Follow'; }?></button>
											
                                        </div>
                                        <div>
                                            <ul class="list-inline">
                                                <?php /*<li class="list-inline-item">
                                                    <a href="https://twitter.com/reactjs" class="d-flex align-items-center" rel="noopener nofollow noreferrer" target="_blank">
                                                ...
                                                <li class="list-inline-item">
                                                    <a href="https://github.com/facebook/react/" class="d-flex align-items-center" rel="noopener nofollow noreferrer" target="_blank">
                                                        <svg viewBox="0 0 24 24">
                                                ...
                                                <li class="list-inline-item">
                                                    <a href="https://reactjs.org/" class="d-flex align-items-center" rel="noopener nofollow noreferrer" target="_blank">
                                                        <svg viewBox="0 0 24 24">
                                ...
                                <div class="community-photo">
									<?php 
										if($tag_info->tag_img != ''){
											$tag_img = 'public/images/tags/thumb/'.$tag_info->tag_img;
										}else{
											$tag_img = 'public/images/empty-tag.png';
										}
									?>
                                    <a href="{{URL::to('/tag/').$tag_info->tag_slug}}"><img data-sizes="auto" src="{{ asset($tag_img)}}" data-src="{{ asset($tag_img)}}" data-width="180" data-height="180" alt="React logo" class="lazyautosizes lazyloaded" sizes="120px"></a>
                                </div>
                            </div>
                        </div>
                        <div>
                            <div class="post-card d-flex flex-row justify-content-between filter-bar">
                               <?php /* <ul class="nav nav-pills">
                                    <li class="nav-item"><a class="nav-link active" href="{{ URL::to('/') }}">Stories</a></li>
                                    <li class="nav-item"><a class="nav-link " href="#">Questions</a></li>
                                    <li class="nav-item"><a class="nav-link " href="#">News</a></li>
                                </ul>*/ ?>
                            </div>
                            <div class="feed-items-wrap main_append" data-page="1" data-acttype="5">
								@php
									$n = 0;
								@endphp
									...
									<div class="d-flex flex-row">
										...
										<div class="hn-post-card-data d-flex flex-grow-1 flex-wrap flex-row">
											...
											<div class="post-content">
												<h1><a href="{{ URL::to('/post/detail/'.base64_encode(convert_uuencode($story->id))) }}">{{$story->title}}</a></h1>
															...
															<div class="d-flex flex-column"><a href="{{ URL::to('/detail/'.base64_encode(convert_uuencode($story->userInfo->id))) }}">{{$story->userInfo->full_name}}</a>
																...
																<div class="d-flex flex-row align-items-center"><a class="username" href="{{ URL::to('/detail/'.base64_encode(convert_uuencode($story->userInfo->id))) }}">@<?php echo $story->userInfo->name; ?></a>
																	...
																	<p class="date-time">
																		...
																		<a href="#" title="February 18, 2019 9:39 PM">
																			<?php 
								...
								<span class="tag-name">Sketch
											...
											<div class="post-cover-image">
												<a href="{{ URL::to('/post/detail/'.base64_encode(convert_uuencode($story->id))) }}" class="d-flex flex-grow-1" style="background-image:url(&quot;{{ asset('public/images/posts/original/'.$story->img) }}&quot;)"></a>
											</div>
											@endif
										</div>
									</div>
								...
								?>
											...
											<div style="margin-bottom: 2%;">
												<h6>Liked by</h6> @for($i=0; $i
												<$n; $i++ ) @if($i <=2 ) <span class="badge badge-light"><img class="circle_img" height="25" width="25" src="{{@$post_likes['img'][$i]}}" title="{{@$post_likes['name'][$i]}}" /></span>
													@endif @endfor @for($i=0; $i
													<$n; $i++ ) @if($i <=1 ) <?php echo ($i> 0)?',': ''; ?> <span class="badge badge-light">{{@$post_likes['name'][$i]}}</span> @endif @if($i == 3) and <span class="badge badge-light"><a href="#" class="init_like_pop" data-pjhfd="{{$story->id}}" data-toggle="modal" data-target="#myModal">{{$n-2}} more</a></span> @endif @endfor
									...
									?>
													...
													<div>
														<a href="{{ URL::to('/post/detail/'.base64_encode(convert_uuencode($story->id))) }}" class="hn-btn no-border d-flex align-items-center">
															<svg viewBox="0 0 24 24">
																<g transform="translate(0 2)" fill="none" fill-rule="evenodd">
																	...
																	<path d="M23.234955 3.0211575V12.57615c0 1.439985-1.170045 2.609985-2.61003 2.609985h-10.2675l-5.49747 5.4300375V15.186135H3.3224175c-1.439985 0-2.609985-1.17-2.609985-2.609985V3.0211575c0-1.439985 1.17-2.609985 2.609985-2.609985h1.20003c-.7874925.1349925-2.28003 1.012485-2.1825225 5.82747.0525075 2.2424925.5099925 4.81503 2.625015 6.0150225 1.9244475 1.0963275 4.71138.9066225 6.872205.9664725 1.800435.0498675 3.603135.017985 5.4006675-.09576 1.4116875-.0893325 3.3002775.05388 4.4716575-.8897325 1.1411475-.898515.945945-2.6100675 1.0454775-3.9034725.0824925-1.0725375.1349925-2.1525.15747-3.2250375.03003-1.0049775.1350375-2.1449925.060015-3.2249925.165015.345015.2625225.7275225.2625225 1.140015z" fill="#659BDB"></path>
																	<circle fill="#FFFFFF" cx="6.5624625" cy="7.798425" r="1.5577125"></circle>
																	<circle fill="#FFFFFF" cx="11.986035" cy="7.798425" r="1.55769"></circle>
																	<circle fill="#FFFFFF" cx="17.409585" cy="7.798425" r="1.55769"></circle>

																	<path d="M4.662105.6249s7.2421875.6328125 11.71875 1.0546875 5.709165.3515625 6.28125 2.8125C23.23419 6.953025 23.23419 7.3749 23.23419 7.3749s.3502725-5.8659375-.743715-6.1790625c-1.0939875-.313125.4997625-.951525-4.2814875-.784665C13.42773.5780325 4.662105.6249 4.662105.6249z" fill="#FFFFFF"></path>
																	<g stroke="#1B4A9A" stroke-linecap="round" stroke-linejoin="round">

																		<path d="M4.859715 15.1883775H3.3256725c-1.442325 0-2.6115825-1.16925-2.6115825-2.61165v-9.55665c0-1.442325 1.1692575-2.61165 2.6115825-2.61165h17.296875c1.442325 0 2.6116425 1.169325 2.6116425 2.61165v9.55665c0 1.4424-1.1693175 2.61165-2.6116425 2.61165h-10.2615M4.859565 15.1883775v5.427l5.5014825-5.427"></path>
																	</g>
																	<circle stroke="#1B4A9A" stroke-linecap="round" stroke-linejoin="round" cx="6.5624625" cy="7.798425" r="1.5577125"></circle>
																	<circle stroke="#1B4A9A" stroke-linecap="round" stroke-linejoin="round" cx="11.986035" cy="7.798425" r="1.55769"></circle>
																	<circle stroke="#1B4A9A" stroke-linecap="round" stroke-linejoin="round" cx="17.409585" cy="7.798425" r="1.55769"></circle>
																</g>
															</svg>
								...
								<span class="show-mobile">Bookmark
														...
														<div class="hide-mobile">
															<a href="https://api.whatsapp.com/send?text={{$story->title}} {{ URL::to('/post/detail/'.base64_encode(convert_uuencode($story->id))) }}" target="_blank" rel="noopener noreferrer" class="hn-flat-btn tweet-btn d-flex align-items-center">
														...
														<div class="dropdown">
															<?php /*<button class="hn-flat-btn d-flex align-items-center" data-toggle="dropdown"><svg viewBox="0 0 24 24">
								...
								<span class="show-mobile">Bookmark
																	...
																	<a class="dropdown-item d-flex align-items-center " href="{{ URL::to('/delete_action?cmnType=1&cmnid='.$story->id) }}">
																		<svg viewBox="0 0 24 24">
								...
								<div class="text-center feed_loader" style="dispaly:none;">
                ...
                <div class="right-sidebar single-community-sidebar">
                    @include('../Elements/groups/right_side')
                </div>
            </div>
			<!--------Report pop-up--------------->
