        ...
        <div class="feed-area">
            <div class="d-flex flex-row">
                        ...
                        <div class="post-card community-header-card">
                            <div class="d-flex flex-row flex-wrap">
                                <div class="community-details">
                                    <h1><a href="{{URL::to('/tag/').$tag_info->tag_slug}}">{{$tag_info->title}}</a></h1>
                                    <p><?php echo nl2br($tag_info->description);?></p>
                                    <div class="d-flex flex-row align-items-center">
                                        <div class="d-flex flex-row align-items-center">
                                            <button class="follow-button active">Following</button>
                                        </div>
                                        <div>
                        ...
                        <div>
                            <div class="post-card d-flex flex-row justify-content-between filter-bar">
                                <ul class="nav nav-pills">
									...
									<?php /*<li class="nav-item"><a class="nav-link " href="#">polls</a></li>*/?>
                                    <li class="nav-item"><a class="nav-link " href="#">News</a></li>
                                </ul>
                            </div>
                            <div class="feed-items-wrap main_append" data-page="1">
								@php
									$n = 0;
								@endphp
                ...
                <div class="right-sidebar single-community-sidebar">
                    @include('../Elements/tags/right_side')
                </div>
            </div>
			<!--------Report pop-up--------------->
