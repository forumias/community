...
<main class="feed-items-wrap" itemprop="mainEntityOfPage">
...
<li class="nav-item">
		<a class="nav-link active" href="{{ URL::to('/') }}">Stories</a></li>
...
<div class="hide-mobile"><a href="https://twitter.com/share?url={{$story->title}}&amp;via=ForumIAS" target="_blank" rel="noopener noreferrer" class="hn-flat-btn tweet-btn d-flex align-items-center"><svg viewBox="0 0 24 24">
...
@if($auth_user)
<div class="dropdown"><button class="hn-flat-btn d-flex align-items-center" data-toggle="dropdown"><svg viewBox="0 0 24 24">
...
@endif
<a class="dropdown-item d-flex align-items-center" href="#"><svg viewBox="0 0 24 24">
