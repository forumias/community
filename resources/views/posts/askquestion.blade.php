    ...
    <div id="signupbox" style=" margin-top:50px" class="mainbox col-md-10 col-md-offset-3 col-sm-8 col-sm-offset-2">
        <div class="panel panel-info">
            ...
            <div class="panel-body" >
				<h2>Ask Question</h2> 
                <form method="post" action="{{URL::to('/askQuestion')}}" class="input_group" enctype="multipart/form-data" id="create_poll">
					@csrf
				  <div class="form-group row">
					<label for="colFormLabelSm" class="col-sm-2 col-form-label col-form-label-sm">Title</label>
					<div class="col-sm-10">
					  <input type="text" class="form-control form-control-sm required" id="colFormLabelSm" placeholder="What's your question?" name="title">
				  ...
				  <div class="form-group row">
					<label for="colFormLabelLg" class="col-sm-2 col-form-label">Category</label>
					<div class="col-sm-10">
					...
					<span class="invalid-feedback"> @if ($errors->has('category_id'))
				  ...
				  <div class="form-group row">
					<button type="submit" class="btn btn-success custom_submit">Ask</button>
				  </div>
				</form>
            </div>
        </div>
